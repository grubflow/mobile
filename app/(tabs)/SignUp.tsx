      ...
      >
        ...
        >
          <View style={[styles.inputButton, { position: 'relative' }]}>
            ...
            <TextInput
              onEndEditing={() => {
                if (email !== '') animateButtonColor(emailFillValue)
              }}
              autoCapitalize="none"
              value={email}
          ...
          >
            ...
            >
              {password ? (
                ...
                <EyeOff color={'black'} strokeWidth={1} width={20}></EyeOff>
              )}
              {password ? (
                <Text
                  style={{
          ...
          >
            ...
            <TextInput
              onEndEditing={() => {
                if (confirmPassword !== '')
                  animateButtonColor(confirmPasswordFillValue),
                    setShowPasswordsDontMatch(password !== confirmPassword)
              }}
              secureTextEntry={!showPassword}
              autoCapitalize="none"
        ...
        >
          ...
          <Button
            ...
            onPress={async () => {
              ...
              else if (user.error?.code === 400) setRegisterNotification(true)
            }}
            loading={false}
            fullWidth
            disabled={
